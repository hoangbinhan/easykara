      ...
      <div className="flex flex-col gap-1.5">
        ...
        >
          <div className="flex items-center gap-2">
            <span className="px-1.5 py-0.5 rounded-[3px] bg-neon-muted text-neon-glow font-mono text-[9px] font-bold uppercase">
              ASS
            </span>
        ...
        >
          <div className="flex items-center gap-2">
            <span className="px-1.5 py-0.5 rounded-[3px] bg-graphite-light text-whiteout font-mono text-[9px] font-bold uppercase">
              LRC
            </span>
